...
SPEC = {"domain":"电力规约转换前置网关","asset_types":["site","channel","point","field_device","control_command"],"signal_names":["raw_frame","telemetry","device_time","channel_heartbeat","queue_depth","channel_health","point_quality"],"action_names":["map_point","forward_telemetry","preset_control","execute_control","switch_channel"],"flow_names":["frame_processing","mapping_release","remote_control","channel_takeover","channel_assessment","frame_deduplication","device_presence","config_change","station_recall"],"config_names":["point_map","channel_policy","source_authorization","retention_policy"]}
