...
class Engine:
    STATES=["received","decoded","mapped","forwarded","acknowledged","invalid"]
    DEFAULT_STATE="received"
    DOMAIN="industrial protocol translation and delivery"
    ...
    def create(self,name: str,**values: Any) -> Entity:
        entity=Entity.create("powerprotocol",name,values.pop("state",self.DEFAULT_STATE),**values)
